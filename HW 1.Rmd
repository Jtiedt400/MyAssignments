...
You need the header information; this won't compile as-is. -1
Good work overall; 17/18
**Theoretical section**
...
```
Don't need to write a new function; can just define Z = 2*Y+1 and look at mean, variance from there.
